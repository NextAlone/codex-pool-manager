...
struct CodexBarUsagePace: Sendable {
    enum Stage: Sendable {
        case onTrack
        case slightlyAhead
        case ahead
    ...
    static func weekly(
        ...
        workDays: Int? = nil,
        calendar: Calendar = .current) -> CodexBarUsagePace?
    {
    ...
    static func historical(
        ...
        projectedRemainingUsage: Double? = nil) -> CodexBarUsagePace
    {
...
struct CodexBarRateWindow: Sendable {
